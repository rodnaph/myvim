...
"   echomsg ""
  ...
  if exists("syntax_on")
    ...
    "                               "  endif
    "
    "                                 hi MatchParen cterm=none  ctermfg=188 ctermbg=68  gui=bold    guifg=#dfdfdf
    "                                 guibg=#5f87df
    "                                   "hi MatchParen    cterm=none  ctermfg=24  ctermbg=153 gui=none    guifg=#005f87
    "                                   guibg=#afdfff
    "                                     "hi MatchParen    cterm=none  ctermfg=117 ctermbg=31  gui=bold
    "                                     guifg=#87dfff   guibg=#0087af
    "                                       "hi MatchParen    cterm=none  ctermfg=187 ctermbg=67  gui=none
    "                                       guifg=#005f87   guibg=#afdfff
    "
    "                                         hi TabLineSel cterm=bold  ctermfg=fg  ctermbg=bg  gui=bold    guifg=fg
    "                                         guibg=bg
    "                                           hi TabLine    cterm=underline ctermfg=fg  ctermbg=242 gui=underline
    "                                           guifg=fg    guibg=#666666
    "                                             hi TabLineFill cterm=underline ctermfg=fg ctermbg=242 gui=underline
    "                                             guifg=fg    guibg=#666666
    "                                             endif
